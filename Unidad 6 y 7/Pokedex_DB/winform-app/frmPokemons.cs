...
namespace winform_app
{
    public partial class frmPokemons : Form
    {
        ...
        private void eliminar(bool logico = false)
        {
            ...
            try
            {
                DialogResult respuesta = MessageBox.Show("¿Confirma eliminación?", "Eliminando", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private bool validarFiltro()
        {
            ...
            if (cboCampo.SelectedItem.ToString() == "Número")
            {
                ...
                {
                    MessageBox.Show("Cargar número a filtrar.");
                    return true;
                }
